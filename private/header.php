...
//     $statement = $con->prepare($sql);
//     $statement->execute();
//     $doctors = $statement->fetchAll(PDO::FETCH_OBJ);

//     $sql = 'SELECT * from hospitals';
//     $statement = $con->prepare($sql);
//     $statement->execute();
//     $hospitals = $statement->fetchAll(PDO::FETCH_OBJ);

//     $sql = 'SELECT * FROM events WHERE date_time < NOW() ORDER BY date_time';
//     $statement = $con->prepare($sql);
//     $statement->execute();
...
//     $sql='SELECT * FROM welcome_youtube_videos WHERE status=1 limit 1';
//     $statement = $con->prepare($sql);
//     $statement->execute();
//     $welcomeYT = $statement->fetchAll(PDO::FETCH_OBJ);

//     $sql='SELECT * FROM youtube_videos;';
//     $statement = $con->prepare($sql);
//     $statement->execute();
//     $youtube_videos = $statement->fetchAll(PDO::FETCH_OBJ);
